        ...
        <div className=" mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-full  lg:px-20 lg:py-4 lg:pb-0">
            <div className="p-8 rounded  sm:p-16">
                <div className="flex flex-col md:flex-row lg:flex-row justify-between items-center">
                    ...
                    <div className="lg:w-2/6 ml-0 md:pl-10 lg:pl-0 lg:mt-8  ">



                        <div className="grid  row-gap-8 hidden lg:grid md:grid  ">
                            <div className="flex flex-col justify-center">
                                ...
                                <div className="max-w-full mb-6 lg:mt-10 md:mt-10  ">
                                    <p className="text-sm text-gray-500 lg:text-lg ikaros font-bold lg:font-thin">
                                        Decentralized system of financial transactions <br />
                                        Tools help digitize and decentralize all transactions <br />
                                        All financial transactions on the blockchain
                                    </p>
                                </div>
