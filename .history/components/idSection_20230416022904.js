    ...
    return (
        <div className="px-4 lg:my-10 md:mb-5   sm:max-w-full md:max-w-full lg:max-w-screen-full md:px-24 lg:px-8   bg-[url('https://i.postimg.cc/J41L1C2P/Asset-16-8.png')] bg-no-repeat lg:bg-contain bg-center bg-[#000] lg:mx-32 md:mx-20 rounded-2xl">
            <div className="flex flex-col max-w-screen-full overflow-hidden k  rounded-2xl shadow-sm lg:flex-row sm:mx-auto lg:py-8 md:py-0 ">
                ...
                <div className="flex flex-col md:flex-row justify-center p-8 bg-transparent lg:p-16 lg:pl-20 md:pl-0 lg:w-1/2 lg:pt-6 md:py-3 ">
                    <div>
                    ...
                    <img
                        src="https://i.postimg.cc/XJpW6f13/Asset-19-8.png"
                        alt=""
                        className="object-cover w-full md:w-50   h-100 lg:h-90 md:h-80 "
                    />
