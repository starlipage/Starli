...
export function FooterSection() {
    ...
    return (
        <footer id="footerSection" className="bg-[#21282e]   mb-4 lg:-mb-3 lg:mt-28">
            <div className="px-4 mx-auto max-w-screen-xl sm:px-6 lg:px-8">
                <div className="lg:grid lg:grid-cols-2">
                    <div
                        className="py-16 border-b border-gray-800 lg:border-b-0 lg:border-l lg:order-last lg:py-24 lg:pb-10 lg:pl-12"
                    >
