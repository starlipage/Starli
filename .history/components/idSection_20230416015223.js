export default function IdSection() {
    return (
        <div className="px-4 py-16  sm:max-w-full md:max-w-full lg:max-w-screen-full md:px-24 lg:px-8 lg:py-10  bg-[url('https://i.postimg.cc/J41L1C2P/Asset-16-8.png')] bg-no-repeat lg:bg-contain bg-center bg-[#000]">
