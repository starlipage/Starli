                    ...
                    <div className="py-10 grid gap-28 md:gap-12 md:grid-cols-4">
                        ...
                        <div className=" space-y-8 group">
                            <div className="max-w-xs p-6 rounded-md bg-gradient-to-r from-[#f9ce34] via-[#ee2a7b] to-[#6228d7]">
                                <img src="https://i.postimg.cc/RFgwZv99/Untitled.png" alt="" className="object-cover object-center w-full rounded-md h-48 " />
                                <div className="mt-6 mb-2">
                                    <h2 className="text-xl font-semibold tracking-wide arkhip">Instagram</h2>
                                </div>
                            </div>
                        </div>
