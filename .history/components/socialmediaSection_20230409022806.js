                        ...
                        <div className=" lg:col-span-2 lg:mx-16 ">
                            ...
                            <div class="grid grid-cols-2 row-gap-2 md:grid-cols-4">
                                <div class="text-center md:border-r">
                                    <img src="./images/instagram.svg" className="w-[60%] ml-5 md:w-[50%] md:mx-auto" />
                                </div>
                                <div class="text-center md:border-r">
                                    <img src="./images/twitter.svg" className="w-[50%] mx-auto" />
                                </div>
                                <div class="text-center md:border-r">
                                    <img src="./images/discord.svg" className="w-[60%] ml-5 md:w-[50%] md:mx-auto mt-7" />
                                </div>
                                <div class="text-center flex items-center ml-8 mt-5 md:mt-0">
