            ...
            <section className="py-14 mt-8">
                <div className="max-w-screen-full mx-auto px-4  gap-x-12 justify-between md:flex md:px-28 lg:items-center" >
                    ...
                    <div className="flex-none mt-4 md:mt-0">
                        ...
                        <a
                            class="inline-flex items-center gap-2 rounded-full border border-indigo-600 px-6 py-8 text-indigo-600 hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
                            href="/download"
                        >
