            ...
            <div className="p-8 rounded  sm:p-16">
                <div className="flex flex-col md:flex-row lg:flex-row justify-between ">
                    <div className="mb-6 lg:mb-0 lg:w-1/2 lg:pr-5">
                        ...
                        <h2 className="mt-6 lg:mt-10 arkhip lg:text-5xl font-bold tracking-wide text-white  leading-loose text-2xl">
                            FOCUS ON MORE
                        </h2>
                        <h2 className="lg:mt-6 arkhip lg:text-[3.6rem] font-bold tracking-wide text-white   text-2xl ">
                            INTERACTION
                        </h2>
                    </div>
                    ...
                    <div className="lg:w-2/6 ml-0 md:pl-10 lg:pl-0  ">
                        ...
                        <div className="grid  row-gap-8 hidden lg:grid md:grid lg:pt-4 ">
                            <div className="flex flex-col justify-center">
                                ...
                                <div className="grid gap-3 row-gap-8 sm:grid-cols-2 hidden lg:grid mt-8  ">
                                    <div>
                                        <div className="flex items-center justify-center w-12 h-12 mb-2 ">
                                            <p className="ikaros text-white font-black lg:text-4xl text-2xl">50+</p>
                                        </div>
                                    ...
                                    <div>
                                        <div className="flex items-center justify-center w-12 h-12 mb-2 ">
                                            <p className="ikaros text-white font-black lg:text-4xl text-2xl">20+</p>
                                        </div>
                                        <h6 className="mb-2 font-thin leading-3 text-gray-200 arkhip lg:text-sm">
                                ...
                                <div className="max-w-full mb-6 lg:mt-10 md:mt-10  ">
                                    <p className="text-sm text-gray-500 lg:text-md ikaros font-bold lg:font-bold">
