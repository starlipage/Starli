                ...
                <div>
                    ...
                    <div className='lg:mt-36  ml-8 lg:ml-20 mr-2 lg:mr-0 text-left item-center  '>
                        <h5 className="text-[3rem] lg:text-7xl md:text-[1.8rem] font-bold arkhip text-white item-center ">
                            ...
                            <div className='flex md:hidden lg:flex'>
                                <span className='lg:text-[3rem] text-3xl lg:mt-4 arkhip md:hidden lg:block	' >Interaction ,  </span> <br />
                            ...
                            <div className='flex -mt-8 lg:mt-0 md:hidden lg:flex'>
                                <span className='arkhip lg:text-[3rem]  text-[1.8rem]' > Communicate </span> <br />
                                <div>
                                    <AcmeLogo />
                                </div>
                            </div>
                    ...
                    <div className='mt-8   lg:block  items-center pb-12'>
                        <div className='flex  items-center md:space-evently justify-center lg:justify-evently  ' >
                            <a className="inline-flex items-center px-8 py-2 text-white bg-transparent border border-[#0f0f0f] rounded-full hover:bg-transparent  active:text-indigo-500 focus:outline-none focus:ring text-2xl arkhip shadow-2xl" href="/whitepaper.pdf" target="_blank">
