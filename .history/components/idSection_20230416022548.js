            ...
            <div className="flex flex-col max-w-screen-full overflow-hidden k  rounded-2xl shadow-sm lg:flex-row sm:mx-auto lg:py-8 md:py-0 ">
                <div className="relative lg:w-1/2">
                    <img
                        ...
                        alt=""
                        className="object-cover w-full md:absolute md:h-80 h-100 lg:h-90 md:block lg:block "
                    />

                </div>
                <div className="flex flex-col justify-center p-8 bg-transparent lg:p-16 lg:pl-20 md:pl-0 lg:w-1/2 lg:pt-6 ">
                    <div>
