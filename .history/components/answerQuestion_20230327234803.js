            ...
            <section className="py-10 mt-8">
                <div className="max-w-screen-full mx-auto px-4  gap-x-12 justify-between md:flex md:px-28 lg:items-center py-8" >
                    <div className="max-w-full">
                        <h3 className="text-gray-200  text-xl md:text-4xl font-semibold lg:text-6xl arkhip lg:ml-8">
                        ...
                        <h3 className="text-gray-200   text-xl md:text-xl font-semibold lg:text-6xl arkhip lg:ml-8 mt-5">
