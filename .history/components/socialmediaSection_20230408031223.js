                ...
                <div className="container mx-auto px-6 md:px-12 text-center ">
                    ...
                    <div className="py-10 grid gap-28 md:gap-12 md:grid-cols-4">
                        ...
                        <div className=" space-y-8 group">
                            <div className="max-w-xs p-6 rounded-md bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
                                <img src="https://source.unsplash.com/random/300x300/?1" alt="" className="object-cover object-center w-full rounded-md h-48 dark:bg-gray-500" />
