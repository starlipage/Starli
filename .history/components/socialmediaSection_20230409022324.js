                ...
                <div className="px-4 py-16 pt-2 mx-auto sm:px-6 lg:pl-8 lg:pr-0 lg:mr-0 sm:py-12 max-w-full">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3  gap-y-8 lg:items-center ml-4">
                        <div className="max-w-xl text-left sm:text-left lg:ml-20">
                            <h2 className=" text-xl md:text-3xl font-bold tracking-tight sm:text-4xl ikaros font-black text-white">
                                Starli in the
                                <br className="hidden sm:block lg:block" />
                                <a className="inline-block px-10 py-2 mr-2 md:py-4 ml-2 lg:mr-2 mt-1 text-sm font-medium text-white bg-gradient-to-tr from-yellow-200 via-green-200 to-green-500 rounded-full transition hover:scale-110 hover:rotate-2 active:bg-indigo-500 focus:outline-none focus:ring" href="/download">
                                </a>
