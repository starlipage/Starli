        ...
        <div className="px-4 lg:my-10 md:mb-8   sm:max-w-full md:max-w-full lg:max-w-screen-full md:px-24 lg:px-8   bg-[url('https://i.postimg.cc/J41L1C2P/Asset-16-8.png')] bg-no-repeat lg:bg-contain bg-center bg-[#000] lg:mx-32 md:mx-20 rounded-2xl">
            <div className="flex flex-col max-w-screen-full overflow-hidden k  rounded-2xl shadow-sm lg:flex-row sm:mx-auto lg:py-8 md:py-0 ">
                ...
                <div className="flex flex-col justify-center p-8 bg-transparent lg:p-16 lg:pl-20 lg:w-1/2 lg:pt-6 ">
                    ...
                    <h5 className="mb-3 text-3xl font-extrabold leading-none lg:text-4xl text-white arkhip md:text-3xl md:hidden lg:block hidden">
                        The star <br />
                        we needed <br />
                        for a long <br />
                        time
                    ...
                    <h5 className="mt-3 text-3xl font-extrabold leading-none lg:text-4xl text-white arkhip md:text-2xl md:block lg:hidden ">
                        The star <br />
                        we needed
                        for a long
                        time
