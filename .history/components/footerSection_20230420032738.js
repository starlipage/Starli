                ...
                <div className="lg:grid lg:grid-cols-2">
                    ...
                    >
                        ...
                        <div className="mt-12 space-y-4 lg:mt-0">
                            ...
                            <div className="text-center lg:text-left">
                                <h5 className="text-2xl font-medium text-white arkhip">join us</h5>

                                <p
                                    className="max-w-md mx-auto mt-4 text-xl leading-relaxed text-gray-100 lg:mx-0 ikaros font-bold"
                                >
                                    Announcements and news of <br /> the Starli project
                                </p>
                            </div>
                            ...
                            <form className="mt-6" onSubmit={onSubmit}>
                                <div className="relative max-w-lg mx-auto lg:mx-0">
                                    ...
                                    <input
                                        className="w-full py-4 pl-3 pr-16 text-sm text-white bg-gray-800 border-none rounded-md ikaros "
                                        id="email"
                                        type="email"
                    ...
                    <div className="pt-2 md:pt-0 pb-0 lg:pt-24 lg:pr-12">
                        ...
                        >
                            ...
                            <p className="mt-4 text-center lg:text-left ikaros">
