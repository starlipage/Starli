export default function IdSection() {
    return (
        <div className="px-4 py-16  sm:max-w-full md:max-w-full lg:max-w-screen-full md:px-24 lg:px-8 lg:py-10  bg-[url('https://i.postimg.cc/fRDJnPcN/Asset-15-8.png')] bg-no-repeat lg:bg-contain bg-center">
            <div className="flex flex-col max-w-screen-full overflow-hidden bg-black  rounded-2xl shadow-sm lg:flex-row sm:mx-auto lg:mx-28 ">
