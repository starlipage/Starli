...
export function FooterSection() {
    ...
    return (
        <footer id="footerSection" className="bg-[#21282e] lg:rounded-b-[10rem] border-solid border-b-8 border-[#21282e] mb-4 lg:-mb-3">
            <div className="px-4 mx-auto max-w-screen-xl sm:px-6 lg:px-8">
                <div className="lg:grid lg:grid-cols-2">
                    <div
                        className="py-16 border-b border-gray-800 lg:border-b-0 lg:border-l lg:order-last lg:py-24 lg:pl-12"
                    >
                        ...
                        <div className="mt-12 space-y-4 lg:mt-0">
                            <span className="bg-teal-500 rounded lg:h-1 lg:w-10 lg:block"></span>
                  ...
                  <nav className="mt-4">
                    <ul className="space-y-1.5 text-sm">
                      ...
                      <li>
                        ...
                        <div
                            className="pt-8 mt-8 text-sm text-white border-t border-gray-800 lg:mt-12 md:mt-0"
                        >
