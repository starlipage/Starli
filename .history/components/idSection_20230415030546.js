export default function IdSection() {
    ...
    return (
        <section className="py-14  ">
            <div className="max-w-screen-full mx-auto px-4 text-gray-600 gap-16  md:px-32 lg:flex bg-[#3417ff] mx-32 py-8">
                ...
                <div className="mt-12 lg:mt-0 mr-8 items-center">
                    ...
                    <h3 className="text-indigo-600 font-semibold text-center mt-2 arkhip text-3xl">
                        STARLI-099
                    </h3>
                </div>
