            ...
            <div className='mt-3'>
                ...
                >
                    ...
                    >
                        ...
                        <li class="flex items-center gap-2  p-2 ml-3 hidden">
                            <span
                                class="h-6 w-6 rounded-b-full rounded-t-2 bg-[#3417ff] text-center text-[10px] font-bold leading-6"
                            >
                        ...
                        <li class="flex items-center gap-2  p-2">
                            <span
                                class="h-6 w-6 rounded-b-full rounded-t-2 bg-[#3417ff] text-center text-[10px] font-bold leading-6 text-white"
                            >
